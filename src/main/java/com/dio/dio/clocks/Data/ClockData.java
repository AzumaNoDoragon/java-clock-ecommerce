...
public class ClockData {
    public static List<Clock> getClocksDatabase() {
        ...
        List<Clock> database = Arrays.asList(
                ...
                new Clock(5L, "Crown & Compass", "https://gwath-store-newdemo.myshopify.com/cdn/shop/files/product_16_31d3ebfc-9bea-428a-a1ca-4724a9c0e5ec.png", 90.00, 80.00, 5),
                new Clock(6L, "Maison Du Temps", "https://gwath-store-newdemo.myshopify.com/cdn/shop/files/product_12_3535ac39-be52-463a-9575-77630a1dc60c.png", 90.00, 80.00, 23),
